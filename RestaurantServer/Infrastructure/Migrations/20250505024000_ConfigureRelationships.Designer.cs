...
namespace RestaurantServer.Infrastructure.Migrations
{
    ...
    [Migration("20250505024000_ConfigureRelationships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantServer.Core.Models.ReservationUser", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("RestaurantServer.Core.Models.ReservationUser", b =>
                {
                    b.HasOne("RestaurantServer.Core.Models.Reservation", "Reservation")
                        .WithMany("ReservationUsers")
                        .HasForeignKey("ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestaurantServer.Core.Models.User", "User")
                        .WithMany("ReservationUsers")
